...
public class Patient extends Person{
    ...
    House address = new House("null","null","null");
    int bpabnormal1 = 0;
    int bpabnormal2 = 0;
    String bp = "null";
    ...
    public Patient(String name, float age, String city, String community, String house, int year, int month, int date, int rate, int heart, int pressure, float kilos, float pounds){
        super(name, age);
    ...
    public static void main(String[] args){
        Patient patient = new Patient("null",0,"null","null","null",0,0,0,0,0,0,0,0);
    ...
    public void Address(){
        Scanner input = new Scanner(System.in);
        System.out.println("please input the address(city, community, house):");
        address.setCity(input.nextLine());
        address.setCommunity(input.nextLine());
    ...
    public void BPabnormal(){
        if(address.getCommunity().equals("community1")){       
            if(bp.equals("abnormal")){
                bpabnormal1 += 1;
            }
            System.out.println("total number of abnormal blood pressure in community1:"+bpabnormal1);
        }
        else if(address.getCommunity().equals("community2")){
            if(bp.equals("abnormal")){
                bpabnormal2 += 1;
            }           
            System.out.println("total number of abnormal blood pressure in community2:"+bpabnormal2);
        }
    }
    
    public void output(){
        Patient patient = new Patient(getName(),getAge(),address.getCity(),address.getCommunity(),address.getHouse(),encounter.getYear(),encounter.getMonth(),encounter.getDate(),encounter.getRate(),encounter.getHeart(),encounter.getPressure(),encounter.getKilos(),encounter.getPounds());
    ...
    public String toString() {
        return "Patient [name:"+getName()+",age:"+getAge()+",city:"+address.getCity()+",community:"+address.getCommunity()+",house:"+address.getHouse()+",year:"+encounter.getYear()+",month:"+encounter.getMonth()+",date:"+encounter.getDate()+",respiratory rate:"+encounter.getRate()+",heart rate:"+encounter.getHeart()+",systolic blood pressure:"+encounter.getPressure()+",weight in kilos:"+encounter.getKilos()+",weight in pounds:"+encounter.getPounds()+" ]";
    }
