 ...
 * @author Ke
 */
public class SellerServiceWorkAreaJPanel extends javax.swing.JPanel {
     ...
     */
    public SellerServiceWorkAreaJPanel(JPanel userProcessContainer, UserAccount account, Enterprise enterprise, EcoSystem business) {
        initComponents();
    ...
    private void initComponents() {
        ...
        add(requestTestJButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(740, 440, -1, -1));
        ...
        add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(245, 97, 680, 260));

        questionjTextField.setBackground(new java.awt.Color(255, 204, 204));
        add(questionjTextField, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 370, 200, -1));
        ...
        add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, -130, 1310, 960));
