 ...
 * @author yamato
 */
public class AppointmentCell extends javax.swing.JPanel {
     ...
     */
    public AppointmentCell(JPanel userProcessContainer, UserAccount account, Organization organization, Enterprise enterprise, EcoSystem business,AbstractQuestion course) {
        initComponents();
        this.course = course;
        ...
        titleLabel.setText(course.getBookdate());
